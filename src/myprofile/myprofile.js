...
import resume from '../images/mc.pdf';
                ...
                <div class="pfmain">
                    <div class="container pfcon  ">
                        <div class="row pfcol">
                            ...
                            <div class="col-md-2 " >
                                <img src={require("../images/j5.jpeg")} class="pfimg" />
                            </div>
                            <div class="col-md-5 pcol">

                                <h1 className="name1">Mohan chandra</h1>
                                ...
                                {this.state.details ? <div className="animated" >
                                    Ph.no : <span class="phno">8978120420</span><br />
                                    Gmail : <span class="gmail">rmcbsatya@gmail.com</span>
                                </div> : null}
                            </div>
                            <div class="col-md-5">
                                ...
                                <div class="wrapper">
                                    <ul className="list-icons">
                                        <div href="" class="social-icon fb">
                                            <a href="https://www.facebook.com/Mohanchandra.brahmam" target="_blank" > <i className="fa fa-facebook"></i></a>

                                        </div>
                                        <div href="#" class="social-icon twitter">
                                            <a href="https://twitter.com/MohanChandr999" target="_blank">  <i className="fa fa-twitter"></i></a>
                                        </div>
                                        <div href="#" class="social-icon linkedin">
                                            <a href="https://www.linkedin.com/in/mohan-chandra-a28a74176/" target="_blank" >  <i className="fa fa-linkedin"></i></a>
                                        </div>
                                        <div class="social-icon insta">
                                            <a href="https://www.instagram.com/mohan__chandraa/" target="_blank"><i className="fa fa-instagram"></i></a>
                                        </div>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="container pfcont">
                        ...
                        {this.state.viewdata === 'profile' ? <div class="row">
                            ...
                            <div class="col-md-6 about">
                                ...
                                <p class="pfpara">
                                    I am Mohan chandra.R from AndhraPradesh and currently staying in banglore.
                                        coming to my education qualification ,i have completed my graduation in the stream of Mechanical Engineering from qis college of engg and technology.
